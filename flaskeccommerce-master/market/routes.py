    ...
    if request.method == "POST":
        ...
        if s_item_object:
            if current_user.can_sell(s_item_object):
                ...
                flash(f"Something went wrong trying to sell! {s_item_object.name}!", category='danger')
...
def register_page():
    ...
    if form.validate_on_submit():
        ...
        flash(f"Account created successfully! You have now logged in as {user_to_create.username}", category='success')
        return redirect(url_for('market_page'))
